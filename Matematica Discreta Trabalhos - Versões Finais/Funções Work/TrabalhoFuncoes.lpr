  ...
  Begin
    ...
    case funcao of
         ...
         'F':   Begin         // Função Raíz
                     ...
                     // Condição inaceitável para a função implementada - encontrada por experimento!!!
                     //if(radicando < 0) and (indice < 0) Then
                                   //begin
                                      //writeln('Esta funcao nao calcula nestas cirscunstancias - Raiz -n de -x!!');
                                      //readkey;
                                      //clrscr;
                                   //end        // Aqui ocorre erro de tratamento lógico por parte do IDE - não implementar assim!
                                              // Me parece que ocorre conflito com o critério de divisão "indice mod 2" dentro dos outros ifs.
                                              // Exemplo: se usarmos radicando := -125 e indice := -3, o -3 dividido por 2 resulta em -1 com resto(mod) := 1.
                                              // Vai conflitar!!!
                     else
                     // Radicando positivo
                                  begin
